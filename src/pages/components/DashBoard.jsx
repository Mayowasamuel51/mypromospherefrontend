                    ...
                    <article className="hidden sticky top-28 bottom-0 rounded-lg bg-purple md:bg-white md:dark:bg-darkBg w-fit md:flex items-center md:items-start text-center md:text-start flex-col justify-between gap-20 py-2 px-2 md:py-6 md:px-6">
                        <div className="flex flex-col md:gap-6 gap-4">
                            ...
                            <div className="flex items-center md:items-start flex-col md:gap-6 gap-4 justify-center">
                                <button className="flex items-center gap-2 duration-200 rounded-md cursor-pointer">
                                    <FaShare size={20} className="text-black dark:bg-darkGray" />
                                    <p className="text-center md:block hidden">share</p>
                                </button>
                                <NavLink to={'profileEdit'} className={({ isActive }) => isActive ? "font-bold md:text-purple" : "text-white dark:text-darkGray md:text-black"}>
                                    <button className="flex items-center gap-2 duration-200rounded-md cursor-pointer">
                                        <IoIosSettings size={20} className="" />
                                        <p className="text-center md:block hidden text-black dark:text-darkGray">Edit profile</p>
                                    </button>
                                </NavLink>
                                <NavLink to={'personal-Info'} className={({ isActive }) => isActive ? "font-bold md:text-purple" : "text-white dark:text-darkGray md:text-black"}>
                                    <button className="flex items-center gap-2 duration-200 rounded-md cursor-pointer">
                            ...
                            <div className="flex items-center md:items-start flex-col md:gap-6 gap-4 justify-center gap-x-6">
                                <NavLink to="/dashboard" className={({ isActive }) => isActive && pathname === "/dashboard" ? "font-bold md:text-purple" : "text-white dark:text-darkGray md:text-black"}>
                                    <button className="flex items-center gap-2 duration-200">
                                        <MdDynamicFeed size={20} />
                                        <span className="md:block hidden">Post</span>
                                    </button>
                                </NavLink>
                                <NavLink to="/dashboard/video" className={({ isActive }) => isActive ? "font-bold md:text-purple" : "text-white dark:text-darkGray md:text-black"}>
                                    <button className="flex items-center gap-2 duration-200">
                                        <FaVideo size={20} />
                                        <span className="md:block hidden">Video</span>
                                    </button>
                        ...
                        <NavLink to={`postAd`} className={({ isActive }) => isActive ? "font-bold md:text-purple" : "text-white dark:text-darkGray md:text-black"}>
                            <button className="cursor-pointer flex items-center gap-2">
