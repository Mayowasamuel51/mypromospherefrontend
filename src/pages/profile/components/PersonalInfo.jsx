      ...
      <div className="mt-2">
        <form>
          <div>
            ...
            <input
              type="text"
              className="border border-purple mt-3 md:w-[80%] focus:outline-none p-2 text-[1rem] rounded-md w-full"
          ...
          <form className="mt-0">
            <div>
              <select
                ...
                className="border border-purple mt-3 focus:outline-none p-2 text-[1rem] rounded-md w-full"
                value={country}
