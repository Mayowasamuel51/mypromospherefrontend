    ...
    <section className="relative">
      ...
      <article className="">
        ...
        <form onSubmit={handleSubmit(formSubmit)}>
          ...
          <div className="flex flex-col gap-5 my-4">
            <div className="">
              <div>
                ...
                <textarea
                  ...
                  name="aboutMe"
                  className="resize-none h-32 bg-slate-100 focus:border focus:border-[#3D217A] dark:border-slate-300 w-[100%] focus:outline-none p-3 text-[1rem] rounded-sm placeholder:text-black "
            ...
            <div className="">
              <div>
                ...
                <input
                  ...
                  className="bg-slate-100 focus:border focus:border-[#3D217A] dark:border-slate-300 w-[100%] focus:outline-none p-3 text-[1rem] rounded-sm placeholder:text-black"
            ...
            <div className="">
              ...
              <input
                ...
                type="number"
                name="user_phone"
                className="bg-slate-100 focus:border focus:border-[#3D217A] dark:border-slate-300 w-full focus:outline-none p-3 text-[1rem] rounded-sm placeholder:text-black"
          ...
          <button
            type="submit"
            className="border border-[#3D217A] bg-[#3D217A] py-2 md:py-4 capitalize w-full text-white rounded-md mt-2 duration-300 hover:bg-transparent hover:text-[#3D217A]">
            Update
          </button>
        </form>
      </article>
