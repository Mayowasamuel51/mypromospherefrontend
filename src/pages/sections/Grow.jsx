...
export default function Grow() {
  return (
    <section className="px-4 pb-16 flex flex-col gap-y-10 bigLg:px-10 bigLg:pt-10 bigLg:pb-20 bigLg:flex-row bigLg:items-center bigLg:gap-x-16">
      <div className=" flex flex-col gap-y-2 bigLg:basis-1/2">
        <div className=" flex flex-col gap-y-2">
          <h3 className="text-xl font-semibold md:text-3xl">Grow your Business</h3>
        ...
        <div className=" flex flex-col gap-y-2">
          <h3 className="text-xl font-semibold md:text-3xl">Connect</h3>
          <p className="md:text-sm text-xs">
