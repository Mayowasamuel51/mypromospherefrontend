...
export default function Grow() {
  return (
    <section className=" px-8 pb-16 flex flex-col gap-y-10 bigLg:px-16 bigLg:pt-10 bigLg:pb-20 bigLg:flex-row bigLg:items-center bigLg:gap-x-16">
      <div className=" flex flex-col gap-y-8 bigLg:basis-1/2">
        <div className=" flex flex-col gap-y-1">
          <h3 className=" text-2xl font-medium md:text-3xl">Grow your Business</h3>
          <p className=" text-sm">
        ...
        <div className=" flex flex-col gap-y-1">
          <h3 className=" text-2xl font-medium md:text-3xl">Connect</h3>
          <p className=" text-sm">
