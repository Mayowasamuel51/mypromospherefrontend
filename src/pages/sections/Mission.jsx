    ...
    <section id="about" className=" max-w-screen-exl px-8 py-20 bigLg:px-16">
      <div className=" flex flex-col items-center gap-y-10 bigLg:flex-row bigLg:gap-x-40 exl:gap-x-52">
        <div className=" flex flex-col gap-y-3 bigLg:basis-1/2">
          <h2 className=" font-['Poppins'] text-3xl font-semibold bigLg:text-7xl">
            Our Mission
          </h2>
          <p className=" font-['Poppins'] text-sm leading-6 bigLg:text-xl bigLg:leading-8">
        ...
        <div>
          ...
          <img
            src={mission}
            alt=""
            className=" md:relative md:right-20 md:top-5 rounded-full w-[200px] h-[200px] object-cover bigLg:w-[300px] bigLg:h-[300px]"
          />
          <img
            src={missionTwo}
            alt=""
            className=" hidden md:block md:relative md:left-20 md:bottom-5 rounded-full w-[200px] h-[200px] object-cover bigLg:w-[300px] bigLg:h-[300px]"
          />
        </div>
      </div>
    </section>
