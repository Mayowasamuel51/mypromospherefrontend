  ...
  return (
    <section className="relative newhero h-screen flex justify-center items-end bigLg:items-center">
      ...
      <div
        className={
          toggleLight
            ? "bg-white dark:bg-darkBg w-full md:w-[95%] lg:w-[60%] rounded-tl-[70px] rounded-tr-[70px] md:rounded-sm bigLg:rounded-3xl p-10 lg:px-8 lg:p-0 flex"
            : "bg-darkBg dark:bg-white w-full md:w-[95%] lg:w-[60%] rounded-tl-[70px] rounded-tr-[70px] md:rounded-sm bigLg:rounded-3xl p-10 lg:px-8 lg:p-0 flex"
        }
      >
        <div className="">
